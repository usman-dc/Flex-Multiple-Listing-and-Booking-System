...
<div class="ulbm-listing-metabox">
	<ul class="nav nav-tabs mb-3" role="tablist">
		...
		<?php foreach ( $tabs as $tab_key => $tab_label ) : ?>
			<li class="nav-item" role="presentation">
				<button class="nav-link <?php echo $first ? 'active' : ''; ?>" id="ulbm-tab-<?php echo esc_attr( $tab_key ); ?>"
					data-bs-toggle="tab" data-bs-target="#ulbm-pane-<?php echo esc_attr( $tab_key ); ?>"
	...
	<div class="tab-content">
		...
		<div class="tab-pane fade show active" id="ulbm-pane-general" role="tabpanel">
			<div class="row g-3">
				...
				<div class="col-md-4">
					...
					<input type="number" class="form-control" name="ulbm_max_guests" value="<?php echo esc_attr( (string) $meta[ ListingMeta::KEY_MAX_GUESTS ] ); ?>" min="1">
				</div>
				<div class="col-md-4">
					<label class="form-label"><?php esc_html_e( 'Check-in time', 'flex-booking-system' ); ?></label>
					<input type="time" class="form-control" name="ulbm_check_in_time" value="<?php echo esc_attr( $meta[ ListingMeta::KEY_CHECK_IN_TIME ] ); ?>">
				</div>
				<div class="col-md-4">
					<label class="form-label"><?php esc_html_e( 'Check-out time', 'flex-booking-system' ); ?></label>
					<input type="time" class="form-control" name="ulbm_check_out_time" value="<?php echo esc_attr( $meta[ ListingMeta::KEY_CHECK_OUT_TIME ] ); ?>">
				</div>
				<div class="col-md-6">
					<label class="form-label"><?php esc_html_e( 'Contact email', 'flex-booking-system' ); ?></label>
					<input type="email" class="form-control" name="ulbm_contact_email" value="<?php echo esc_attr( $meta[ ListingMeta::KEY_CONTACT_EMAIL ] ); ?>">
				</div>
				<div class="col-md-6">
					<label class="form-label"><?php esc_html_e( 'Contact phone', 'flex-booking-system' ); ?></label>
					<input type="tel" class="form-control" name="ulbm_contact_phone" value="<?php echo esc_attr( $meta[ ListingMeta::KEY_CONTACT_PHONE ] ); ?>">
				</div>
				<div class="col-md-6">
					<label class="form-label"><?php esc_html_e( 'Video URL (YouTube / Vimeo)', 'flex-booking-system' ); ?></label>
					<input type="url" class="form-control" name="ulbm_video_url" value="<?php echo esc_attr( $meta[ ListingMeta::KEY_VIDEO_URL ] ); ?>">
				</div>
				<div class="col-md-6">
					<div class="form-check mt-4">
						<input class="form-check-input" type="checkbox" name="ulbm_instant_booking" id="ulbm_instant_booking" <?php checked( $meta[ ListingMeta::KEY_INSTANT_BOOKING ] ); ?>>
						<label class="form-check-label" for="ulbm_instant_booking"><?php esc_html_e( 'Enable instant booking (no admin approval needed)', 'flex-booking-system' ); ?></label>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="tab-pane fade" id="ulbm-pane-pricing" role="tabpanel">
			<div class="row g-3">
				<div class="col-md-4">
					...
					<input type="text" class="form-control" name="ulbm_base_price" value="<?php echo esc_attr( $meta[ ListingMeta::KEY_BASE_PRICE ] ); ?>" placeholder="0.00">
				</div>
				<div class="col-md-4">
					<label class="form-label"><?php esc_html_e( 'Sale price', 'flex-booking-system' ); ?></label>
					<input type="text" class="form-control" name="ulbm_sale_price" value="<?php echo esc_attr( $meta[ ListingMeta::KEY_SALE_PRICE ] ); ?>" placeholder="">
				</div>
				<div class="col-md-4">
					<label class="form-label"><?php esc_html_e( 'Price suffix', 'flex-booking-system' ); ?></label>
					<input type="text" class="form-control" name="ulbm_price_suffix" value="<?php echo esc_attr( $meta[ ListingMeta::KEY_PRICE_SUFFIX ] ); ?>" placeholder="<?php esc_attr_e( '/ night', 'flex-booking-system' ); ?>">
				...
				<div class="col-md-4">
					...
					<input type="number" class="form-control" name="ulbm_min_booking" value="<?php echo esc_attr( (string) $meta[ ListingMeta::KEY_MIN_BOOKING ] ); ?>" min="1">
				</div>
				<div class="col-md-4">
					<label class="form-label"><?php esc_html_e( 'Max booking (days/hours)', 'flex-booking-system' ); ?></label>
					<input type="number" class="form-control" name="ulbm_max_booking" value="<?php echo esc_attr( (string) $meta[ ListingMeta::KEY_MAX_BOOKING ] ); ?>" min="1">
				</div>
				<div class="col-md-4">
					<label class="form-label"><?php esc_html_e( 'Deposit %', 'flex-booking-system' ); ?></label>
					<input type="number" class="form-control" name="ulbm_deposit_percent" value="<?php echo esc_attr( (string) $meta[ ListingMeta::KEY_DEPOSIT_PERCENT ] ); ?>" min="0" max="100">
				</div>
				<div class="col-md-4">
					<label class="form-label"><?php esc_html_e( 'Free cancellation (days before)', 'flex-booking-system' ); ?></label>
					<input type="number" class="form-control" name="ulbm_cancellation_days" value="<?php echo esc_attr( (string) $meta[ ListingMeta::KEY_CANCELLATION_DAYS ] ); ?>" min="0">
				</div>
			</div>
		</div>
		...
		<div class="tab-pane fade" id="ulbm-pane-gallery" role="tabpanel">
			...
			<input type="hidden" name="ulbm_gallery" id="ulbm-gallery-ids" value="<?php echo esc_attr( implode( ',', $meta[ ListingMeta::KEY_GALLERY ] ) ); ?>">
			<div id="ulbm-gallery-preview" class="d-flex flex-wrap gap-2 mb-3">
				<?php foreach ( $meta[ ListingMeta::KEY_GALLERY ] as $att_id ) : ?>
					...
					<?php if ( $thumb ) : ?>
						<div class="ulbm-gallery-thumb position-relative" data-id="<?php echo esc_attr( (string) $att_id ); ?>">
							<img src="<?php echo esc_url( $thumb ); ?>" style="width:80px;height:80px;object-fit:cover;border-radius:4px;">
							<button type="button" class="btn-close btn-close-white position-absolute top-0 end-0 ulbm-gallery-remove" style="background-color:rgba(0,0,0,.5);padding:4px;font-size:8px;" aria-label="<?php esc_attr_e( 'Remove', 'flex-booking-system' ); ?>"></button>
						</div>
					<?php endif; ?>
				<?php endforeach; ?>
			</div>
			<button type="button" class="btn btn-outline-primary btn-sm" id="ulbm-gallery-add"><?php esc_html_e( 'Add images', 'flex-booking-system' ); ?></button>
		</div>
		...
		<div class="tab-pane fade" id="ulbm-pane-location" role="tabpanel">
			<div class="row g-3">
				<div class="col-12">
					...
					<input type="text" class="form-control" name="ulbm_address" value="<?php echo esc_attr( $meta[ ListingMeta::KEY_ADDRESS ] ); ?>" placeholder="<?php esc_attr_e( '123 Main St, City, Country', 'flex-booking-system' ); ?>">
				</div>
				<div class="col-md-4">
					<label class="form-label"><?php esc_html_e( 'Latitude', 'flex-booking-system' ); ?></label>
					<input type="text" class="form-control" name="ulbm_latitude" value="<?php echo esc_attr( $meta[ ListingMeta::KEY_LATITUDE ] ); ?>">
				</div>
				<div class="col-md-4">
					<label class="form-label"><?php esc_html_e( 'Longitude', 'flex-booking-system' ); ?></label>
					<input type="text" class="form-control" name="ulbm_longitude" value="<?php echo esc_attr( $meta[ ListingMeta::KEY_LONGITUDE ] ); ?>">
				</div>
				<div class="col-md-4">
					<label class="form-label"><?php esc_html_e( 'Map zoom', 'flex-booking-system' ); ?></label>
					<input type="number" class="form-control" name="ulbm_map_zoom" value="<?php echo esc_attr( (string) $meta[ ListingMeta::KEY_MAP_ZOOM ] ); ?>" min="1" max="20">
				</div>
			</div>
		</div>
		...
		<div class="tab-pane fade" id="ulbm-pane-features" role="tabpanel">
			...
			<input type="hidden" name="ulbm_features_json" id="ulbm-features-json" value="<?php echo esc_attr( wp_json_encode( $meta[ ListingMeta::KEY_FEATURES ] ) ); ?>">
			<div id="ulbm-features-list" class="mb-3"></div>
			<button type="button" class="btn btn-outline-primary btn-sm" id="ulbm-feature-add"><?php esc_html_e( 'Add feature', 'flex-booking-system' ); ?></button>
		</div>
		...
		<div class="tab-pane fade" id="ulbm-pane-services" role="tabpanel">
			...
			<input type="hidden" name="ulbm_extra_services_json" id="ulbm-services-json" value="<?php echo esc_attr( wp_json_encode( $meta[ ListingMeta::KEY_EXTRA_SERVICES ] ) ); ?>">
			<div id="ulbm-services-list" class="mb-3"></div>
			<button type="button" class="btn btn-outline-primary btn-sm" id="ulbm-service-add"><?php esc_html_e( 'Add service', 'flex-booking-system' ); ?></button>
		</div>
		...
		<div class="tab-pane fade" id="ulbm-pane-faq" role="tabpanel">
			...
			<input type="hidden" name="ulbm_faq_json" id="ulbm-faq-json" value="<?php echo esc_attr( wp_json_encode( $meta[ ListingMeta::KEY_FAQ ] ) ); ?>">
			<div id="ulbm-faq-list" class="mb-3"></div>
			<button type="button" class="btn btn-outline-primary btn-sm" id="ulbm-faq-add"><?php esc_html_e( 'Add FAQ', 'flex-booking-system' ); ?></button>
		</div>
	</div>
</div>
