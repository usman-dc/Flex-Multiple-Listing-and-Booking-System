...
<div class="fbs-listing-metabox">
	...
	<div class="tab-content">
			...
			<div class="row g-3">
				...
				<div class="col-md-6">
					<div class="form-check mt-4">
						...
						<label class="form-check-label" for="fbs_instant_booking"><?php esc_html_e( 'Enable instant booking (no admin approval needed)', 'flex-multiple-listing-and-booking-system' ); ?></label>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="tab-pane fade" id="fbs-pane-pricing" role="tabpanel">
			<div class="row g-3">
				...
				<div class="col-md-4">
					...
					<input type="text" class="form-control" name="fbs_price_suffix" value="<?php echo esc_attr( $meta[ ListingMeta::KEY_PRICE_SUFFIX ] ); ?>" placeholder="<?php esc_attr_e( '/ night', 'flex-multiple-listing-and-booking-system' ); ?>">
				...
				<?php foreach ( $meta[ ListingMeta::KEY_GALLERY ] as $att_id ) : ?>
					...
					<?php if ( $thumb ) : ?>
						<div class="fbs-gallery-thumb position-relative" data-id="<?php echo esc_attr( (string) $att_id ); ?>">
							...
							<button type="button" class="btn-close btn-close-white position-absolute top-0 end-0 fbs-gallery-remove" style="background-color:rgba(0,0,0,.5);padding:4px;font-size:8px;" aria-label="<?php esc_attr_e( 'Remove', 'flex-multiple-listing-and-booking-system' ); ?>"></button>
						</div>
					<?php endif; ?>
				<?php endforeach; ?>
			</div>
			<button type="button" class="btn btn-outline-primary btn-sm" id="fbs-gallery-add"><?php esc_html_e( 'Add images', 'flex-multiple-listing-and-booking-system' ); ?></button>
		</div>
		...
		<div class="tab-pane fade" id="fbs-pane-location" role="tabpanel">
			<div class="row g-3">
				<div class="col-12">
					...
					<input type="text" class="form-control" name="fbs_address" value="<?php echo esc_attr( $meta[ ListingMeta::KEY_ADDRESS ] ); ?>" placeholder="<?php esc_attr_e( '123 Main St, City, Country', 'flex-multiple-listing-and-booking-system' ); ?>">
				</div>
				<div class="col-md-4">
		...
		<div class="tab-pane fade" id="fbs-pane-features" role="tabpanel">
			...
			<button type="button" class="btn btn-outline-primary btn-sm" id="fbs-feature-add"><?php esc_html_e( 'Add feature', 'flex-multiple-listing-and-booking-system' ); ?></button>
		</div>
		...
		<div class="tab-pane fade" id="fbs-pane-services" role="tabpanel">
			...
			<button type="button" class="btn btn-outline-primary btn-sm" id="fbs-service-add"><?php esc_html_e( 'Add service', 'flex-multiple-listing-and-booking-system' ); ?></button>
		</div>
		...
		<div class="tab-pane fade" id="fbs-pane-faq" role="tabpanel">
			...
			<button type="button" class="btn btn-outline-primary btn-sm" id="fbs-faq-add"><?php esc_html_e( 'Add FAQ', 'flex-multiple-listing-and-booking-system' ); ?></button>
		</div>
	</div>
</div>
