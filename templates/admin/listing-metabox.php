			...
			<div class="row g-3">
				...
				<div class="col-md-6">
					...
					<select class="form-select" name="ulbm_booking_mode">
						<option value="daily" <?php selected( $meta[ ListingMeta::KEY_BOOKING_MODE ], 'daily' ); ?>><?php esc_html_e( 'Daily (check-in / check-out)', 'flex-multiple-listing-and-booking-system' ); ?></option>
						<option value="hourly" <?php selected( $meta[ ListingMeta::KEY_BOOKING_MODE ], 'hourly' ); ?>><?php esc_html_e( 'Hourly', 'flex-multiple-listing-and-booking-system' ); ?></option>
						<option value="time_slot" <?php selected( $meta[ ListingMeta::KEY_BOOKING_MODE ], 'time_slot' ); ?>><?php esc_html_e( 'Fixed time slots', 'flex-multiple-listing-and-booking-system' ); ?></option>
					</select>
				</div>
				<div class="col-md-4">
		...
		<div class="tab-pane fade" id="ulbm-pane-pricing" role="tabpanel">
			<div class="row g-3">
				...
				<div class="col-md-4">
					...
					<input type="text" class="form-control" name="ulbm_price_suffix" value="<?php echo esc_attr( $meta[ ListingMeta::KEY_PRICE_SUFFIX ] ); ?>" placeholder="<?php esc_attr_e( '/ night', 'flex-multiple-listing-and-booking-system' ); ?>">
		...
		<div class="tab-pane fade" id="ulbm-pane-location" role="tabpanel">
			<div class="row g-3">
				<div class="col-12">
					...
					<input type="text" class="form-control" name="ulbm_address" value="<?php echo esc_attr( $meta[ ListingMeta::KEY_ADDRESS ] ); ?>" placeholder="<?php esc_attr_e( '123 Main St, City, Country', 'flex-multiple-listing-and-booking-system' ); ?>">
				</div>
				<div class="col-md-4">
