...
$fbs_shortcodes_help = array(
	array( 'tag' => 'fbs_booking_form', 'description' => __( 'Booking form for a specific type.', 'flex-booking-system' ), 'example' => '[fbs_booking_form id="1"]', 'attrs' => '<code>id</code> (required)' ),
	array( 'tag' => 'fbs_listing_grid', 'description' => __( 'Listing grid with AJAX filters.', 'flex-booking-system' ), 'example' => '[fbs_listing_grid type="car-rental" columns="3" limit="12"]', 'attrs' => '<code>type</code>, <code>columns</code>, <code>limit</code>' ),
	array( 'tag' => 'fbs_search', 'description' => __( 'Search UI (AJAX).', 'flex-booking-system' ), 'example' => '[fbs_search]', 'attrs' => '<code>layout</code>' ),
	array( 'tag' => 'fbs_register', 'description' => __( 'Partner registration form.', 'flex-booking-system' ), 'example' => '[fbs_register]', 'attrs' => '—' ),
	array( 'tag' => 'fbs_login', 'description' => __( 'Partner login form.', 'flex-booking-system' ), 'example' => '[fbs_login]', 'attrs' => '—' ),
	array( 'tag' => 'fbs_dashboard', 'description' => __( 'Partner dashboard (listings, bookings, profile).', 'flex-booking-system' ), 'example' => '[fbs_dashboard]', 'attrs' => '—' ),
	array( 'tag' => 'fbs_become_partner', 'description' => __( 'Call-to-action block for partner signup.', 'flex-booking-system' ), 'example' => '[fbs_become_partner]', 'attrs' => '<code>title</code>, <code>text</code>' ),
);
...
<div class="wrap fbs-admin-wrap container-fluid py-3">
	...
	<div class="fbs-page-header mb-4">
		<h1 class="h3 mb-1 fbs-page-title"><?php echo esc_html( fbs_plugin_menu_label() . ' — ' . __( 'Settings', 'flex-booking-system' ) ); ?></h1>
	...
	<form method="post" id="fbs-settings-form" action="<?php echo esc_url( admin_url( 'admin.php?page=fbs-settings' ) ); ?>">
		...
		<ul class="nav nav-tabs mb-4" role="tablist" id="fbs-settings-tabs">
			<li class="nav-item"><button class="nav-link<?php echo 'general' === $fbs_settings_tab ? ' active' : ''; ?>" data-bs-toggle="tab" data-bs-target="#fbs-st-general" data-fbs-tab="general" type="button"><?php esc_html_e( 'General', 'flex-booking-system' ); ?></button></li>
			<li class="nav-item"><button class="nav-link<?php echo 'colors' === $fbs_settings_tab ? ' active' : ''; ?>" data-bs-toggle="tab" data-bs-target="#fbs-st-colors" data-fbs-tab="colors" type="button"><?php esc_html_e( 'Colors', 'flex-booking-system' ); ?></button></li>
			<li class="nav-item"><button class="nav-link<?php echo 'layout' === $fbs_settings_tab ? ' active' : ''; ?>" data-bs-toggle="tab" data-bs-target="#fbs-st-layout" data-fbs-tab="layout" type="button"><?php esc_html_e( 'Layout', 'flex-booking-system' ); ?></button></li>
			<li class="nav-item"><button class="nav-link<?php echo 'notify' === $fbs_settings_tab ? ' active' : ''; ?>" data-bs-toggle="tab" data-bs-target="#fbs-st-notify" data-fbs-tab="notify" type="button"><?php esc_html_e( 'Notifications', 'flex-booking-system' ); ?></button></li>
			<li class="nav-item"><button class="nav-link<?php echo 'shortcodes' === $fbs_settings_tab ? ' active' : ''; ?>" data-bs-toggle="tab" data-bs-target="#fbs-st-shortcodes" data-fbs-tab="shortcodes" type="button"><?php esc_html_e( 'Shortcodes', 'flex-booking-system' ); ?></button></li>
			<li class="nav-item"><button class="nav-link<?php echo 'cpts' === $fbs_settings_tab ? ' active' : ''; ?>" data-bs-toggle="tab" data-bs-target="#fbs-st-cpts" data-fbs-tab="cpts" type="button"><?php esc_html_e( 'Post Types', 'flex-booking-system' ); ?></button></li>
			<li class="nav-item"><button class="nav-link<?php echo 'demo' === $fbs_settings_tab ? ' active' : ''; ?>" data-bs-toggle="tab" data-bs-target="#fbs-st-demo" data-fbs-tab="demo" type="button"><?php esc_html_e( 'Demo Content', 'flex-booking-system' ); ?></button></li>
			<li class="nav-item"><button class="nav-link<?php echo 'partner' === $fbs_settings_tab ? ' active' : ''; ?>" data-bs-toggle="tab" data-bs-target="#fbs-st-partner" data-fbs-tab="partner" type="button"><?php esc_html_e( 'Partner Portal', 'flex-booking-system' ); ?></button></li>
		</ul>
			...
			<div class="tab-pane fade<?php echo 'colors' === $fbs_settings_tab ? ' show active' : ''; ?>" id="fbs-st-colors">
				<div class="fbs-admin-panel border rounded bg-white p-4 mb-4">
					<div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
						...
						<button type="button" class="btn btn-outline-secondary btn-sm" id="fbs-reset-colors"><?php esc_html_e( 'Reset all colors to defaults', 'flex-booking-system' ); ?></button>
					</div>
					...
					<button type="button" class="btn btn-sm btn-outline-warning mb-3" id="fbs-fix-page-bg"><?php esc_html_e( 'Fix red page background (reset to light gray)', 'flex-booking-system' ); ?></button>
					<?php
					...
					<div id="fbs-color-preview" class="fbs-color-preview mt-2 p-4 border rounded" style="<?php echo esc_attr( ColorSettings::admin_preview_inline_style() ); ?>">
						...
						<div class="fbs-color-preview-page rounded p-3">
							<div class="fbs-color-preview-card rounded p-3 shadow-sm">
								<span class="fbs-color-preview-badge"><?php esc_html_e( 'Featured', 'flex-booking-system' ); ?></span>
								<div class="fbs-color-preview-title fw-bold"><?php esc_html_e( 'Sample listing title', 'flex-booking-system' ); ?></div>
								<div class="fbs-color-preview-muted small"><?php esc_html_e( 'Downtown · 4 guests', 'flex-booking-system' ); ?></div>
								<div class="fbs-color-preview-price fw-bold my-2">$299 <span class="fbs-color-preview-sale small"><?php esc_html_e( 'was $349', 'flex-booking-system' ); ?></span></div>
								<div class="fbs-color-preview-stars small mb-2" aria-hidden="true">★★★★★</div>
								<button type="button" class="fbs-color-preview-btn me-1" data-fbs-preview="primary"><?php esc_html_e( 'Book now', 'flex-booking-system' ); ?></button>
								<button type="button" class="fbs-color-preview-btn me-1" data-fbs-preview="secondary"><?php esc_html_e( 'Secondary', 'flex-booking-system' ); ?></button>
								<button type="button" class="fbs-color-preview-btn me-1" data-fbs-preview="success"><?php esc_html_e( 'Success', 'flex-booking-system' ); ?></button>
								<button type="button" class="fbs-color-preview-btn" data-fbs-preview="accent"><?php esc_html_e( 'Accent', 'flex-booking-system' ); ?></button>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="tab-pane fade" id="fbs-st-layout">
				<div class="fbs-admin-panel border rounded bg-white p-4 mb-4">
					...
					<div class="row g-3 align-items-end">
						<div class="col-md-4">
							<label class="form-label" for="fbs_container_width"><?php esc_html_e( 'Max container width (px)', 'flex-booking-system' ); ?></label>
					...
					<div class="row g-3">
						...
						<div class="col-md-4">
							<div class="form-check mt-4">
								...
								<label class="form-check-label" for="fbs_card_shadow"><?php esc_html_e( 'Card shadow on hover', 'flex-booking-system' ); ?></label>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-check mt-4">
								<input class="form-check-input" type="checkbox" name="fbs_show_filters" id="fbs_show_filters" <?php checked( ! empty( $s['show_filters'] ) ); ?>>
								<label class="form-check-label" for="fbs_show_filters"><?php esc_html_e( 'Show filter bar on grid', 'flex-booking-system' ); ?></label>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row g-3">
						<div class="col-md-4">
							...
							<div class="form-check">
								...
								<label class="form-check-label" for="fbs_grid_show_rating"><?php esc_html_e( 'Show star rating & review count', 'flex-booking-system' ); ?></label>
							</div>
						</div>
						<div class="col-md-4">
							...
							<div class="form-check">
								...
								<label class="form-check-label" for="fbs_grid_show_amenities"><?php esc_html_e( 'Show amenities on cards', 'flex-booking-system' ); ?></label>
							</div>
						</div>
						<div class="col-md-4">
							<label class="form-label" for="fbs_grid_amenities_limit"><?php esc_html_e( 'Max amenities per card', 'flex-booking-system' ); ?></label>
					...
					<div class="row g-3">
						<div class="col-md-6">
							<div class="form-check">
								...
								<label class="form-check-label" for="fbs_reviews_enabled"><?php esc_html_e( 'Allow guests to submit reviews on listing pages', 'flex-booking-system' ); ?></label>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-check">
								...
								<label class="form-check-label" for="fbs_reviews_auto_approve"><?php esc_html_e( 'Publish reviews immediately (skip admin approval)', 'flex-booking-system' ); ?></label>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row g-3">
						<div class="col-12">
							<div class="form-check">
								...
								<label class="form-check-label fw-semibold" for="fbs_notify_customer_status"><?php esc_html_e( 'Enable customer emails on status changes', 'flex-booking-system' ); ?></label>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-check"><input class="form-check-input" type="checkbox" name="fbs_notify_on_confirmed" id="fbs_nc1" <?php checked( ! empty( $s['notify_on_confirmed'] ) ); ?>><label class="form-check-label" for="fbs_nc1"><?php esc_html_e( 'Confirmed / Accepted', 'flex-booking-system' ); ?></label></div>
							<div class="form-check"><input class="form-check-input" type="checkbox" name="fbs_notify_on_completed" id="fbs_nc2" <?php checked( ! empty( $s['notify_on_completed'] ) ); ?>><label class="form-check-label" for="fbs_nc2"><?php esc_html_e( 'Completed', 'flex-booking-system' ); ?></label></div>
							<div class="form-check"><input class="form-check-input" type="checkbox" name="fbs_notify_on_cancelled" id="fbs_nc3" <?php checked( ! empty( $s['notify_on_cancelled'] ) ); ?>><label class="form-check-label" for="fbs_nc3"><?php esc_html_e( 'Cancelled', 'flex-booking-system' ); ?></label></div>
						</div>
						<div class="col-md-6">
							<div class="form-check"><input class="form-check-input" type="checkbox" name="fbs_notify_on_rejected" id="fbs_nc4" <?php checked( ! empty( $s['notify_on_rejected'] ) ); ?>><label class="form-check-label" for="fbs_nc4"><?php esc_html_e( 'Rejected', 'flex-booking-system' ); ?></label></div>
							<div class="form-check"><input class="form-check-input" type="checkbox" name="fbs_notify_on_hold" id="fbs_nc5" <?php checked( ! empty( $s['notify_on_on_hold'] ) ); ?>><label class="form-check-label" for="fbs_nc5"><?php esc_html_e( 'On hold', 'flex-booking-system' ); ?></label></div>
							<div class="form-check"><input class="form-check-input" type="checkbox" name="fbs_notify_on_pending" id="fbs_nc6" <?php checked( ! empty( $s['notify_on_pending'] ) ); ?>><label class="form-check-label" for="fbs_nc6"><?php esc_html_e( 'Pending', 'flex-booking-system' ); ?></label></div>
						</div>
						<div class="col-md-6">
				...
				<div class="fbs-admin-panel border rounded bg-white p-4 mb-4">
					...
					<?php if ( ! empty( $fbs_all_types_for_sc ) ) : ?>
						<div class="row g-3 align-items-end mb-3">
							<div class="col-md-3">
								<label class="form-label" for="fbs-demo-count"><?php esc_html_e( 'Posts per type', 'flex-booking-system' ); ?></label>
							...
							<div class="col-md-9">
								<div class="form-check mt-4">
									...
									<label class="form-check-label fw-semibold" for="fbs-demo-select-all"><?php esc_html_e( 'Select all booking types', 'flex-booking-system' ); ?></label>
								</div>
							</div>
						</div>
					...
					<?php else : ?>
						<div class="alert alert-warning mb-0">
							...
							<a href="<?php echo esc_url( admin_url( 'admin.php?page=fbs-booking-types' ) ); ?>" class="alert-link"><?php esc_html_e( 'Open Booking Types', 'flex-booking-system' ); ?></a>
						</div>
					<?php endif; ?>
				</div>
			</div>
									...
									<tr data-page-key="<?php echo esc_attr( $fbs_vkey ); ?>">
										...
										<td class="fbs-vendor-page-actions">
											<?php if ( $fbs_vrow['edit_url'] ) : ?>
												<a href="<?php echo esc_url( $fbs_vrow['edit_url'] ); ?>" class="btn btn-sm btn-outline-secondary"><?php esc_html_e( 'Edit', 'flex-booking-system' ); ?></a>
											<?php endif; ?>
										</td>
									</tr>
								<?php endforeach; ?>
					...
					<div class="row g-3 mb-4">
						...
						<div class="col-md-6">
							<div class="form-check">
								...
								<label class="form-check-label" for="fbs_vendor_auto_approve"><?php esc_html_e( 'Auto-approve new partner registrations', 'flex-booking-system' ); ?></label>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-check">
								...
								<label class="form-check-label" for="fbs_vendor_auto_publish"><?php esc_html_e( 'Publish partner listings immediately (otherwise pending review)', 'flex-booking-system' ); ?></label>
							</div>
						</div>
					</div>
