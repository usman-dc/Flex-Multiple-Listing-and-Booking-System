...
<div class="wrap ulbm-admin-wrap container-fluid py-3">
	...
	<div class="ulbm-page-header d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
		<div>
			<h1 class="h3 mb-1 ulbm-page-title"><?php esc_html_e( 'Dashboard', 'flex-booking-system' ); ?></h1>
	...
	<div class="row g-3 mb-4">
		...
		<div class="col-6 col-lg-3">
			<div class="ulbm-stat-card border rounded bg-white p-3 h-100">
				...
				<a class="small" href="<?php echo esc_url( admin_url( 'admin.php?page=ulbm-booking-types' ) ); ?>"><?php esc_html_e( 'Manage', 'flex-booking-system' ); ?></a>
			</div>
		</div>
	</div>
		...
		<div class="col-lg-7">
			<div class="ulbm-admin-panel border rounded bg-white h-100">
				<div class="ulbm-admin-panel-head px-3 py-3 d-flex justify-content-between align-items-center border-bottom">
					...
					<a class="small" href="<?php echo esc_url( admin_url( 'admin.php?page=ulbm-bookings' ) ); ?>"><?php esc_html_e( 'View all', 'flex-booking-system' ); ?></a>
				</div>
				<div class="p-0">
