		...
		<div class="fbs-admin-panel border rounded bg-white mb-4">
			...
			<div class="p-3">
				<form method="post" action="<?php echo esc_url( $list_url ); ?>" class="row g-3">
					...
					<div class="col-md-6">
						<label class="form-label" for="fbs_type_name"><?php esc_html_e( 'Name', 'flex-multiple-listing-and-booking-system' ); ?></label>
						<input class="form-control" name="fbs_type_name" id="fbs_type_name" value="<?php echo esc_attr( $val_name ); ?>" required maxlength="191" />
					</div>
					<div class="col-md-6">
						<label class="form-label" for="fbs_type_slug"><?php esc_html_e( 'Slug', 'flex-multiple-listing-and-booking-system' ); ?></label>
					...
					<div class="col-12">
						<label class="form-label" for="fbs_type_description"><?php esc_html_e( 'Description', 'flex-multiple-listing-and-booking-system' ); ?></label>
					...
					<div class="col-md-6">
						<label class="form-label" for="fbs_type_industry"><?php esc_html_e( 'Industry / form profile', 'flex-multiple-listing-and-booking-system' ); ?></label>
					...
					<div class="col-md-6">
						<label class="form-label" for="fbs_type_status"><?php esc_html_e( 'Status', 'flex-multiple-listing-and-booking-system' ); ?></label>
	...
	<?php if ( ! $fbs_show_type_form ) : ?>
		...
		<?php if ( ! empty( $fbs_available_industries ) ) : ?>
			...
			(function(){
				...
				btn.addEventListener('click', function(){
					...
					btn.disabled = true;
					st.textContent = '<?php echo esc_js( __( 'Creating...', 'flex-multiple-listing-and-booking-system' ) ); ?>';
					var fd = new FormData();
		...
		<div class="fbs-admin-panel border rounded bg-white">
			<div class="fbs-admin-panel-head px-3 py-3 d-flex flex-wrap justify-content-between align-items-center gap-2 border-bottom bg-white">
				...
				<span class="badge text-bg-light border"><?php echo esc_html( (string) (int) $fbs_types_total ); ?> <?php esc_html_e( 'records', 'flex-multiple-listing-and-booking-system' ); ?></span>
			</div>
									...
									<tr>
										...
										<td class="small">
											<div class="d-flex flex-wrap gap-1">
												<a class="btn btn-sm btn-outline-primary" href="<?php echo esc_url( add_query_arg( 'fbs_edit', (string) $tid, $edit_base ) ); ?>"><?php esc_html_e( 'Edit', 'flex-multiple-listing-and-booking-system' ); ?></a>
