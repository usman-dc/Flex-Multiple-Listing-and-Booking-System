							...
							<tr data-review-id="<?php echo esc_attr( (string) $review['id'] ); ?>">
								...
								<td class="text-end text-nowrap">
									<?php if ( 'pending' === $status || 'rejected' === $status ) : ?>
										<button type="button" class="btn btn-sm btn-success fbs-review-approve" data-id="<?php echo esc_attr( (string) $review['id'] ); ?>"><?php esc_html_e( 'Approve', 'flex-booking-system' ); ?></button>
									<?php endif; ?>
									<?php if ( 'pending' === $status || 'approved' === $status ) : ?>
										<button type="button" class="btn btn-sm btn-outline-secondary fbs-review-reject" data-id="<?php echo esc_attr( (string) $review['id'] ); ?>"><?php esc_html_e( 'Reject', 'flex-booking-system' ); ?></button>
									<?php endif; ?>
									<button type="button" class="btn btn-sm btn-outline-danger fbs-review-delete" data-id="<?php echo esc_attr( (string) $review['id'] ); ?>"><?php esc_html_e( 'Delete', 'flex-booking-system' ); ?></button>
								</td>
							</tr>
						<?php endforeach; ?>
					<?php endif; ?>
