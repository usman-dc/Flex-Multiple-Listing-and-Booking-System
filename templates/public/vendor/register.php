		...
		<div class="col-lg-7 col-xl-6">
			<div class="border rounded bg-white p-4 shadow-sm">
				...
				<form id="ulbm-vendor-register-form" class="row g-3" novalidate>
					<div class="col-md-6">
						<label class="form-label" for="ulbm-reg-first"><?php esc_html_e( 'First name', 'flex-booking-system' ); ?> <span class="text-danger">*</span></label>
						<input type="text" class="form-control" id="ulbm-reg-first" name="first_name" required>
					</div>
					<div class="col-md-6">
						<label class="form-label" for="ulbm-reg-last"><?php esc_html_e( 'Last name', 'flex-booking-system' ); ?> <span class="text-danger">*</span></label>
						<input type="text" class="form-control" id="ulbm-reg-last" name="last_name" required>
					</div>
					<div class="col-md-6">
						<label class="form-label" for="ulbm-reg-email"><?php esc_html_e( 'Email', 'flex-booking-system' ); ?> <span class="text-danger">*</span></label>
						<input type="email" class="form-control" id="ulbm-reg-email" name="email" required>
					</div>
					<div class="col-md-6">
						<label class="form-label" for="ulbm-reg-phone"><?php esc_html_e( 'Phone', 'flex-booking-system' ); ?></label>
						<input type="tel" class="form-control" id="ulbm-reg-phone" name="phone">
					</div>
					<div class="col-12">
						<label class="form-label" for="ulbm-reg-business"><?php esc_html_e( 'Business / brand name', 'flex-booking-system' ); ?></label>
						<input type="text" class="form-control" id="ulbm-reg-business" name="business_name" placeholder="<?php esc_attr_e( 'Optional', 'flex-booking-system' ); ?>">
					</div>
					<div class="col-md-6">
						<label class="form-label" for="ulbm-reg-pass"><?php esc_html_e( 'Password', 'flex-booking-system' ); ?> <span class="text-danger">*</span></label>
						<input type="password" class="form-control" id="ulbm-reg-pass" name="password" minlength="6" required>
					</div>
					<div class="col-md-6">
						<label class="form-label" for="ulbm-reg-pass2"><?php esc_html_e( 'Confirm password', 'flex-booking-system' ); ?> <span class="text-danger">*</span></label>
