		...
		<div class="col-lg-7 col-xl-6">
			<div class="border rounded bg-white p-4 shadow-sm">
				...
				<form id="fbs-vendor-register-form" class="row g-3" novalidate>
					<div class="col-md-6">
						<label class="form-label" for="fbs-reg-first"><?php esc_html_e( 'First name', 'flex-multiple-listing-and-booking-system' ); ?> <span class="text-danger">*</span></label>
						<input type="text" class="form-control" id="fbs-reg-first" name="first_name" required>
					</div>
					<div class="col-md-6">
						<label class="form-label" for="fbs-reg-last"><?php esc_html_e( 'Last name', 'flex-multiple-listing-and-booking-system' ); ?> <span class="text-danger">*</span></label>
						<input type="text" class="form-control" id="fbs-reg-last" name="last_name" required>
					</div>
					<div class="col-md-6">
						<label class="form-label" for="fbs-reg-email"><?php esc_html_e( 'Email', 'flex-multiple-listing-and-booking-system' ); ?> <span class="text-danger">*</span></label>
						<input type="email" class="form-control" id="fbs-reg-email" name="email" required>
					</div>
					<div class="col-md-6">
						<label class="form-label" for="fbs-reg-phone"><?php esc_html_e( 'Phone', 'flex-multiple-listing-and-booking-system' ); ?></label>
						<input type="tel" class="form-control" id="fbs-reg-phone" name="phone">
					</div>
					<div class="col-12">
						<label class="form-label" for="fbs-reg-business"><?php esc_html_e( 'Business / brand name', 'flex-multiple-listing-and-booking-system' ); ?></label>
						<input type="text" class="form-control" id="fbs-reg-business" name="business_name" placeholder="<?php esc_attr_e( 'Optional', 'flex-multiple-listing-and-booking-system' ); ?>">
					</div>
					<div class="col-md-6">
						<label class="form-label" for="fbs-reg-pass"><?php esc_html_e( 'Password', 'flex-multiple-listing-and-booking-system' ); ?> <span class="text-danger">*</span></label>
						<input type="password" class="form-control" id="fbs-reg-pass" name="password" minlength="6" required>
					</div>
					<div class="col-md-6">
						<label class="form-label" for="fbs-reg-pass2"><?php esc_html_e( 'Confirm password', 'flex-multiple-listing-and-booking-system' ); ?> <span class="text-danger">*</span></label>
