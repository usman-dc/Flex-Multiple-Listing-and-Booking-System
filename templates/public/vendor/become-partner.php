		...
		<div class="col-lg-7 col-xl-6">
			<div class="border rounded bg-white p-4 shadow-sm">
				...
				<form id="fbs-vendor-become-partner-form" class="row g-3" novalidate>
					<div class="col-12">
						<label class="form-label" for="fbs-bp-business"><?php esc_html_e( 'Business / brand name', 'flex-multiple-listing-and-booking-system' ); ?></label>
						<input type="text" class="form-control" id="fbs-bp-business" name="business_name" value="<?php echo esc_attr( $user->display_name ); ?>">
					</div>
					<div class="col-12">
						<label class="form-label" for="fbs-bp-phone"><?php esc_html_e( 'Phone', 'flex-multiple-listing-and-booking-system' ); ?></label>
