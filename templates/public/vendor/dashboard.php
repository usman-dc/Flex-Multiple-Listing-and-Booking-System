		...
		<div class="col-lg-3">
			<div class="border rounded bg-white p-3 shadow-sm">
				...
				<nav class="nav flex-column gap-1">
					<a class="nav-link rounded <?php echo 'overview' === $fbs_vendor_tab ? 'active bg-primary text-white' : 'text-dark'; ?>" href="<?php echo esc_url( $tab_url( 'overview' ) ); ?>"><i class="bi bi-speedometer2 me-2"></i><?php esc_html_e( 'Overview', 'flex-booking-system' ); ?></a>
					<a class="nav-link rounded <?php echo 'listings' === $fbs_vendor_tab ? 'active bg-primary text-white' : 'text-dark'; ?>" href="<?php echo esc_url( $tab_url( 'listings' ) ); ?>"><i class="bi bi-grid me-2"></i><?php esc_html_e( 'My Listings', 'flex-booking-system' ); ?></a>
					<a class="nav-link rounded <?php echo 'add' === $fbs_vendor_tab ? 'active bg-primary text-white' : 'text-dark'; ?>" href="<?php echo esc_url( $tab_url( 'add' ) ); ?>"><i class="bi bi-plus-circle me-2"></i><?php esc_html_e( 'Add Listing', 'flex-booking-system' ); ?></a>
					<a class="nav-link rounded <?php echo 'bookings' === $fbs_vendor_tab ? 'active bg-primary text-white' : 'text-dark'; ?>" href="<?php echo esc_url( $tab_url( 'bookings' ) ); ?>"><i class="bi bi-calendar-check me-2"></i><?php esc_html_e( 'Bookings', 'flex-booking-system' ); ?></a>
					<a class="nav-link rounded <?php echo 'profile' === $fbs_vendor_tab ? 'active bg-primary text-white' : 'text-dark'; ?>" href="<?php echo esc_url( $tab_url( 'profile' ) ); ?>"><i class="bi bi-gear me-2"></i><?php esc_html_e( 'Profile', 'flex-booking-system' ); ?></a>
									...
									?>
										<tr data-listing-id="<?php echo esc_attr( (string) $lid ); ?>">
											...
											<td class="text-end">
												...
												<button type="button" class="btn btn-sm btn-outline-danger fbs-vendor-delete-listing" data-id="<?php echo esc_attr( (string) $lid ); ?>"><?php esc_html_e( 'Delete', 'flex-booking-system' ); ?></button>
											</td>
										</tr>
									<?php endforeach; ?>
								</tbody>
			...
			<?php elseif ( 'profile' === $fbs_vendor_tab ) : ?>
				<div class="border rounded bg-white p-4 shadow-sm">
					...
					<dl class="row mb-0">
						...
						<dd class="col-sm-9"><?php echo esc_html( $fbs_vendor_record ? ucfirst( (string) $fbs_vendor_record['status'] ) : __( 'Active', 'flex-booking-system' ) ); ?></dd>
					</dl>
				</div>
			<?php endif; ?>
		</div>
