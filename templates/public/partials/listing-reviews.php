...
<div class="fbs-section fbs-reviews-section mb-4" id="fbs-reviews">
	<h2 class="fbs-section-title"><?php esc_html_e( 'Guest Reviews', 'flex-multiple-listing-and-booking-system' ); ?></h2>
	...
	<div class="fbs-review-form-wrap">
		...
		<form class="fbs-review-form" data-listing-id="<?php echo esc_attr( (string) $post_id ); ?>" novalidate>
			<div class="row g-3">
				<div class="col-md-6">
					<label class="form-label" for="fbs-review-name-<?php echo esc_attr( (string) $post_id ); ?>"><?php esc_html_e( 'Your name', 'flex-multiple-listing-and-booking-system' ); ?></label>
				...
				<div class="col-md-6">
					<label class="form-label" for="fbs-review-email-<?php echo esc_attr( (string) $post_id ); ?>"><?php esc_html_e( 'Email', 'flex-multiple-listing-and-booking-system' ); ?></label>
				...
				<div class="col-12">
					<label class="form-label" for="fbs-review-rating-<?php echo esc_attr( (string) $post_id ); ?>"><?php esc_html_e( 'Rating', 'flex-multiple-listing-and-booking-system' ); ?></label>
				...
				<div class="col-12">
					<label class="form-label" for="fbs-review-content-<?php echo esc_attr( (string) $post_id ); ?>"><?php esc_html_e( 'Your review', 'flex-multiple-listing-and-booking-system' ); ?></label>
					<textarea class="form-control fbs-review-content" id="fbs-review-content-<?php echo esc_attr( (string) $post_id ); ?>" rows="4" required placeholder="<?php esc_attr_e( 'Tell others about your stay or experience…', 'flex-multiple-listing-and-booking-system' ); ?>"></textarea>
				</div>
				<div class="col-12">
