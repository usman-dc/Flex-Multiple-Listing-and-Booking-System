...
$post_id = isset( $ulbm_review_listing_id ) ? (int) $ulbm_review_listing_id : get_the_ID();
...
<div class="ulbm-section ulbm-reviews-section mb-4" id="ulbm-reviews">
	<h2 class="ulbm-section-title"><?php esc_html_e( 'Guest Reviews', 'flex-booking-system' ); ?></h2>
			...
			<?php foreach ( $reviews as $review ) : ?>
				<article class="ulbm-review-item">
					<header class="ulbm-review-item-header">
						<strong class="ulbm-review-author"><?php echo esc_html( (string) $review['author_name'] ); ?></strong>
						...
						<time class="ulbm-review-date text-muted small" datetime="<?php echo esc_attr( (string) $review['created_at'] ); ?>">
	...
	<div class="ulbm-review-form-wrap">
		...
		<form class="ulbm-review-form" data-listing-id="<?php echo esc_attr( (string) $post_id ); ?>" novalidate>
			<div class="row g-3">
				<div class="col-md-6">
					<label class="form-label" for="ulbm-review-name-<?php echo esc_attr( (string) $post_id ); ?>"><?php esc_html_e( 'Your name', 'flex-booking-system' ); ?></label>
					<input type="text" class="form-control ulbm-review-name" id="ulbm-review-name-<?php echo esc_attr( (string) $post_id ); ?>" value="<?php echo esc_attr( $prefill_name ); ?>" required>
				</div>
				<div class="col-md-6">
					<label class="form-label" for="ulbm-review-email-<?php echo esc_attr( (string) $post_id ); ?>"><?php esc_html_e( 'Email', 'flex-booking-system' ); ?></label>
					<input type="email" class="form-control ulbm-review-email" id="ulbm-review-email-<?php echo esc_attr( (string) $post_id ); ?>" value="<?php echo esc_attr( $prefill_email ); ?>" required>
				</div>
				<div class="col-12">
					<label class="form-label" for="ulbm-review-rating-<?php echo esc_attr( (string) $post_id ); ?>"><?php esc_html_e( 'Rating', 'flex-booking-system' ); ?></label>
					<select class="form-select ulbm-review-rating" id="ulbm-review-rating-<?php echo esc_attr( (string) $post_id ); ?>">
				...
				<div class="col-12">
					<label class="form-label" for="ulbm-review-content-<?php echo esc_attr( (string) $post_id ); ?>"><?php esc_html_e( 'Your review', 'flex-booking-system' ); ?></label>
					<textarea class="form-control ulbm-review-content" id="ulbm-review-content-<?php echo esc_attr( (string) $post_id ); ?>" rows="4" required placeholder="<?php esc_attr_e( 'Tell others about your stay or experience…', 'flex-booking-system' ); ?>"></textarea>
				</div>
				<div class="col-12">
