		...
		<div class="d-flex align-items-center justify-content-between gap-2 flex-wrap">
			...
			<div class="ulbm-account-toolbar-actions d-flex align-items-center gap-2 ms-auto">
				...
				<?php else : ?>
					...
					<a href="<?php echo esc_url( $account_url ); ?>" class="btn btn-light btn-sm border ulbm-account-icon-btn" title="<?php esc_attr_e( 'Account / Log in', 'flex-booking-system' ); ?>" aria-label="<?php esc_attr_e( 'Account / Log in', 'flex-booking-system' ); ?>">
