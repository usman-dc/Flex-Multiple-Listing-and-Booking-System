...
<div class="ulbm-booking-widget">
	<h2 class="ulbm-booking-widget-title"><?php esc_html_e( 'Book Your Stay', 'flex-multiple-listing-and-booking-system' ); ?></h2>
	<div class="ulbm-booking-widget-form">
		<?php if ( $ulbm_booking_type_id > 0 ) : ?>
			<?php echo do_shortcode( '[ulbm_booking_form id="' . $ulbm_booking_type_id . '"]' ); ?>
		<?php else : ?>
