...
<div class="fbs-booking-widget">
	<h2 class="fbs-booking-widget-title"><?php esc_html_e( 'Book Your Stay', 'flex-booking-system' ); ?></h2>
	...
	<p class="fbs-trust-note"><i class="bi bi-shield-check" aria-hidden="true"></i><?php esc_html_e( "You won't be charged yet.", 'flex-booking-system' ); ?></p>
</div>
