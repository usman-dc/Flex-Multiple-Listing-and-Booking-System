	...
	<?php if ( ! $ulbm_gallery_embedded ) : ?><div class="container ulbm-container py-3"><?php endif; ?>
		<div class="ulbm-gallery-mosaic">
			<div class="ulbm-gallery-mosaic-main">
				<?php if ( $is_featured ) : ?>
					<span class="ulbm-gallery-badge"><?php esc_html_e( 'Featured', 'flex-booking-system' ); ?></span>
				<?php endif; ?>
				...
				<button type="button" class="ulbm-gallery-open ulbm-gallery-main-trigger border-0 p-0 w-100 h-100" data-index="0" aria-label="<?php esc_attr_e( 'View full image', 'flex-booking-system' ); ?>">
				...
				<div class="ulbm-gallery-mosaic-side">
					<?php foreach ( $side as $idx => $img ) : ?>
						...
						?>">
							...
							<?php if ( $is_last ) : ?>
								<span class="ulbm-gallery-more">+<?php echo esc_html( (string) $extra ); ?> <?php esc_html_e( 'Photos', 'flex-booking-system' ); ?></span>
							<?php endif; ?>
						</button>
					<?php endforeach; ?>
				</div>
		...
		<div class="modal-dialog modal-fullscreen">
			<div class="modal-content bg-dark border-0">
				...
				<div class="modal-body d-flex align-items-center justify-content-center p-0 position-relative">
					<button type="button" class="ulbm-lightbox-prev btn btn-dark btn-lg rounded-circle border-0" aria-label="<?php esc_attr_e( 'Previous', 'flex-booking-system' ); ?>"><i class="bi bi-chevron-left"></i></button>
					<img src="" alt="" class="ulbm-lightbox-img img-fluid">
					<button type="button" class="ulbm-lightbox-next btn btn-dark btn-lg rounded-circle border-0" aria-label="<?php esc_attr_e( 'Next', 'flex-booking-system' ); ?>"><i class="bi bi-chevron-right"></i></button>
				</div>
