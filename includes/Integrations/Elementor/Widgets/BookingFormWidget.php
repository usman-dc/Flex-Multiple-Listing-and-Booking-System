<?php
/**
 * Elementor widget: embeds [ulbm_booking_form] with full controls.
 *
...
final class BookingFormWidget extends Widget_Base {
	...
	public function get_title() {
		return __( 'Flex Listings Booking Form', 'flex-multiple-listing-and-booking-system' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} .ulbm-booking-form' => 'border-radius: {{SIZE}}{{UNIT}};',
				),
			)
		);
	...
	protected function render() {
		...
		$shortcode = sprintf( '[ulbm_booking_form type="%s" id="%d"]', esc_attr( $slug ), $id );
