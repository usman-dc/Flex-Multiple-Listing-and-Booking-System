...
/**
 * Declares fields rendered on [fbs_booking_form] per catalog industry key.
 */
final class PublicBookingFields {
	 ...
	 *
	 * @param array<string, mixed>|null $booking_type Row from fbs_booking_types or null.
	...
	public static function groups_for_type( $booking_type ) {
		...
		return apply_filters( 'fbs_public_booking_field_groups', $groups, $booking_type );
	}
}
