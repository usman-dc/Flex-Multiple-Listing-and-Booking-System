	...
	public function incomplete_notice() {
		...
		printf(
			wp_kses(
				...
				__( 'Flex Listings & Booking needs a quick setup: <a href="%s">choose your booking industries</a> (cars, hotels, appointments, …) and finish.', 'flex-multiple-listing-and-booking-system' ),
				array(
					'a' => array(
						'href' => array(),
					),
