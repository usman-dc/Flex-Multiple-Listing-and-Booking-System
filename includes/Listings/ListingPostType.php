<?php
/**
 * Registers the ulbm_listing CPT and its taxonomies.
 *
...
final class ListingPostType {
	...
	public const POST_TYPE        = 'ulbm_listing';
	public const TAX_CATEGORY     = 'ulbm_listing_category';
	public const TAX_AMENITY      = 'ulbm_listing_amenity';
	public const TAX_LOCATION     = 'ulbm_listing_location';
	public const TAX_LISTING_TYPE = 'ulbm_listing_type';
